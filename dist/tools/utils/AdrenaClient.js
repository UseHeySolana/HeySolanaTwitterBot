...
class AdrenaClient {
    ...
    static load(agent) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [cortex, mainPool] = yield Promise.all([
            ...
            const custodies = yield program.account.custody.fetchMultiple(custodiesAddresses);
            if (!custodies.length || custodies.some((c) => c === null)) {
                throw new Error("Custodies not found");
            }
            return new AdrenaClient(program, mainPool, cortex, custodies.map((c, i) => (Object.assign(Object.assign({}, c), { pubkey: custodiesAddresses[i] }))));
        });
    }
    ...
    static isAccountInitialized(connection, address) {
        return __awaiter(this, void 0, void 0, function* () {
